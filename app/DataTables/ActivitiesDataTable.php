...
class UsersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('created_at', function (Facilitie $facilitie) {
                return  UtilityFacades::dateFormat($facilitie->created_at);
            })
            ->editColumn('role', function (User $facilitie) {
                return (count($facilitie->roles))?$facilitie->roles->first()->name:'-';
            })
            ->addColumn('action', function (Facilitie $facilitie) {
                return view('facilities.action', compact('facilitie'));
            });
    }


    public function query(Facilitie $model)
    {
