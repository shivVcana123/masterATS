...
$arrPermissions['resources/views/layouts/menu.blade.php']   = __DIR__ . "/resources/views/layouts/menu.blade.php";
$arrPermissions['resources/model_schemas/'] = __DIR__ . "/resources/model_schemas/";
$arrPermissions['app/Http/Controllers/']= __DIR__ . "/app/Http/Controllers/";
$arrPermissions['app/DataTables/']= __DIR__ . "/app/DataTables/";
$arrPermissions['app/Models/']= __DIR__ . "/app/Models/";
$arrPermissions['app/Http/Requests/API/']= __DIR__ . "/app/Http/Requests/API/";
$arrPermissions['resources/views/']= __DIR__ . "/resources/views/";
$arrPermissions['routes/api.php']= __DIR__ . "/routes/api.php";
$arrPermissions['routes/web.php']= __DIR__ . "/routes/web.php";
$arrPermissions['database/migrations/']= __DIR__ . "/database/migrations/";
$arrPermissions['database/factories/']= __DIR__ . "/database/factories/";
$arrPermissions['tests/APIs/']= __DIR__ . "/tests/APIs/";
$arrPermissions['tests/Repositories/']= __DIR__ . "/tests/Repositories/";
$arrPermissions['app/Models/']= __DIR__ . "/app/Models/";
